...
export default function Dashboard() {
    return (
        <div className="bg-gray-100 min-h-screen p-6 space-y-6">
            ...
            <div className="flex gap-2 rounded-3xl bg-white">
                {/* Left Section */}
                <div className="w-[64%] bg-white h-full p-6 flex flex-col gap-8 rounded-3xl">
                    <StatsCard/>
                    <DistributorRequests />
                    <TopProducts />
                </div>
                {/* Right Section */}
                <div className="w-[36%] bg-white h-full flex flex-col p-6 justify-between rounded-3xl gap-6">
